'''import random
str="qwertyuiopasdfghjklzxcvbnm!@#$%&*_+-/QWERTYUIOPLKJHGFDSAZXCVBNM,.?"
def fun(s):
    password=""
    if s>=8 and s<16:
        while len(password)<s:
        ...
        while x>0:
            t=x-1
            print("Enter the length of your desired password between 8 and 16")
            print("you have more",t,"chances.")
            x-=1
            return fun1()
def fun1(n):
    s=int(input())
